...
| OpenStack
| Supported
| Limited safe reconciliation for mutable items such as tags and security-group rules

| VMware
| Supported
| Detection only; remediation is manual

| Kind
| Not applicable
| No infrastructure drift backend
...
| AWS
| Removed from GA drift registry
| Not supported
|===
