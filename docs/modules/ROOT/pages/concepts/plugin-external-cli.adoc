...
If you want to add a cluster-managed service, use the internal service plugin path described in xref:concepts/plugin-internal-services.adoc[Plugin Internal Services].
...
. Discover executables matching the `opencenter-` prefix.
