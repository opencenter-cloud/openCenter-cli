...
. *Read the code structure* - xref:contributing/code-structure.adoc[Code Structure]
. *Learn the build system* - xref:contributing/build-system.adoc[Build System]
. *Write your first test* - xref:contributing/testing-guide.adoc[Testing Guide]
. *Make your first contribution* - xref:contributing/contributing.adoc[Contributing]
