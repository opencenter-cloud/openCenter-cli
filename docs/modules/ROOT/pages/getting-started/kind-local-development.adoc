...
* xref:operations/integrate-ci-cd.adoc[Integrate CI/CD] - Automate testing

*Testing:*

* xref:operations/validate-configuration.adoc[Validate Configuration] - Test configurations
* xref:operations/troubleshoot-deployment.adoc[Troubleshoot Deployment] - Debug issues

*Production:*

* xref:getting-started/openstack-first-cluster.adoc[OpenStack First Cluster] - Deploy to production
* xref:getting-started/vmware-deployment.adoc[VMware Deployment] - Deploy to VMware
