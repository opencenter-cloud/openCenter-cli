...
* Completed xref:getting-started/getting-started.adoc[Getting Started] tutorial
...
* xref:operations/backup-and-restore.adoc[Backup and Restore] - Disaster recovery for all clusters
* xref:operations/upgrade-kubernetes.adoc[Upgrade Kubernetes] - Upgrade all clusters
* xref:operations/migrate-clusters.adoc[Migrate Clusters] - Migrate between providers

*Advanced Topics:*

* xref:operations/integrate-ci-cd.adoc[Integrate CI/CD] - Automate deployments
* xref:concepts/configuration-lifecycle.adoc[Configuration Lifecycle] - Configuration management

*Understanding:*

* xref:concepts/architecture.adoc[Organization Model] - Multi-tenancy patterns
