...
* xref:operations/configure-networking.adoc[Configure Networking] - CNI and load balancer configuration
* xref:operations/manage-secrets.adoc[Manage Secrets] - Encrypt service secrets
* xref:operations/backup-and-restore.adoc[Backup and Restore] - Configure Velero backups
