...
* Cluster backup (see xref:operations/backup-and-restore.adoc[Backup and Restore])
...
* xref:operations/backup-and-restore.adoc[Backup and Restore] - Backup before upgrade
* xref:operations/troubleshoot-deployment.adoc[Troubleshoot Deployment] - Debug upgrade issues
* xref:concepts/configuration-lifecycle.adoc[Configuration Lifecycle] - Configuration management
* xref:reference/platform-services.adoc[Platform Services] - Service compatibility
