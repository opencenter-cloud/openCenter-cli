...
| VMware
| GA
| Production vSphere environments
...
| Baremetal
| GA
| Pre-provisioned physical infrastructure

| AWS
| Planned / non-GA infrastructure provider
| Not recommended for GA cluster provisioning
|===
