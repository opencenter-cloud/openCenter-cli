...
* xref:./vmware.adoc[Full VMware Guide]
* xref:reference/platform-services.adoc[vSphere CSI Configuration]
* xref:getting-started/getting-started.adoc[Kubespray Deployment]
