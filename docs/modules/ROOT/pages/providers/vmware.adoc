...
* xref:getting-started/getting-started.adoc[Kubespray Deployment Method]
* xref:reference/platform-services.adoc[vSphere CSI Driver Configuration]
* xref:providers/README.adoc[Baremetal Provider] (similar architecture)
* xref:reference/platform-services.adoc[Storage Configuration]
