...
| `--config-dir`
| string
| Override the openCenter configuration directory

| `--output`
| string
| Output format for supported commands: `text`, `json`, `yaml`
...
* xref:reference/environment-variables.adoc[Environment Variables] -- Full env var reference
* xref:reference/file-locations.adoc[File Locations] -- All file paths
* xref:reference/configuration-schema.adoc[Configuration Schema] -- Cluster config structure
* xref:reference/cli-commands.adoc[CLI Commands] -- Flag reference per command
