...
. Command-line flags (the set override mechanism)
. Configuration file
...
See link:../tutorials/getting-started.md#step-3-configure-your-cluster[Getting Started Tutorial] for complete configuration examples.
