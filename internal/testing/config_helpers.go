...
func SaveConfig(t *testing.T, cfg v2.Config) {
	t.Helper()
...
// Note: This skips validation to allow tests to save incomplete configs.
func SaveConfigWithPathResolver(t *testing.T, cfg v2.Config, pathResolver *paths.PathResolver) {
	t.Helper()
...
func SaveConfigWithValidation(t *testing.T, cfg v2.Config) error {
	t.Helper()
...
// It handles manager initialization and provides a clean API for tests.
func LoadConfig(t *testing.T, name string) v2.Config {
	t.Helper()
...
func ValidateConfig(t *testing.T, cfg v2.Config) error {
	t.Helper()
